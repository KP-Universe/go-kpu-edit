...
import (
	...
	"github.com/KP-Universe/go-kpu/crypto/signify"
	"github.com/KP-Universe/go-kpu/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/KP-Universe/go-kpu/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/KP-Universe/go-kpu/internal/version.gitDate="+env.Date)
	}
